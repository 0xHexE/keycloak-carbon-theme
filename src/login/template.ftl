    ...
    <body class="${properties.bodyClass!}">
      ...
      <#if displayMessage && message?has_content>
        <div data-notification
             class="bx--toast-notification <#if message.type='error'>bx--toast-notification--error</#if> <#if message.type='success'>bx--toast-notification--success</#if> <#if message.type='warning'>bx--toast-notification--warning</#if> <#if message.type='info'>bx--toast-notification--info</#if> fixed-notification"
             role="alert">
